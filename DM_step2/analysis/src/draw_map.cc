...
//constant
//TFile *f = new TFile("../root/DMmuon_const_100.root","");
//TFile *f = new TFile("../root/DMmuon_const_10.root","");
//TFile *f = new TFile("../root/DMmuon_const_1.root","");
//TFile *f = new TFile("../root/DMmuon_const_0p5.root","");
//TFile *f = new TFile("../root/DMmuon_const_0p05.root","");

//maxwell
//TFile *f = new TFile("../root/DMmuon_maxwell_100.root","");
//TFile *f = new TFile("../root/DMmuon_maxwell_10.root","");
//TFile *f = new TFile("../root/DMmuon_maxwell_1.root","");
//TFile *f = new TFile("../root/DMmuon_maxwell_0p5.root","");
TFile *f = new TFile("../root/DMmuon_maxwell_0p05.root","");
