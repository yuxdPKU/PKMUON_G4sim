...
//  _tree->Branch("GemTrkID", &GemTrkID, "GemTrkID[3]/I");
//  _tree->Branch("GemTrkMID", &GemTrkMID, "GemTrkMID[3]/I");
  _tree->Branch("GemTrkPx", &GemTrkPx, "GemTrkPx[3]/D");
  _tree->Branch("GemTrkPy", &GemTrkPy, "GemTrkPy[3]/D");
  _tree->Branch("GemTrkPz", &GemTrkPz, "GemTrkPz[3]/D");
  _tree->Branch("GemTrkE", &GemTrkE, "GemTrkE[3]/D");
  _tree->Branch("GemTrkEdep", &GemTrkEdep, "GemTrkEdep[3]/D");
  _tree->Branch("GemTrkX", &GemTrkX, "GemTrkX[3]/D");
  _tree->Branch("GemTrkY", &GemTrkY, "GemTrkY[3]/D");
  _tree->Branch("GemTrkZ", &GemTrkZ, "GemTrkZ[3]/D");
