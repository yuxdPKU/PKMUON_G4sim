...
DetectorConstruction::DetectorConstruction()
  : G4VUserDetectorConstruction(),fScoringVolume(nullptr),fScoringVolume2(nullptr),fScoringVolume3(nullptr)
{
...
G4VPhysicalVolume *DetectorConstruction::DefineVolumes()
{
  ...
  G4VSolid* vac_box = new G4Box("vac_box",shell_x/2,  shell_y/2,  1*um/2); 
  G4LogicalVolume* vacLog = new G4LogicalVolume(vac_box, vacum,"vacLog",0, 0, 0);

  Zcenter = Gem_z+shell_z+1*um/2;
  G4cout<<"vacLog pos1 = "<<Zcenter<<G4endl;
  new G4PVPlacement(0,                       //no rotation
              G4ThreeVector(0,0,Zcenter),                    //at position
